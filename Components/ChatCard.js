...
class ChatCard extends Component {
  ...
  deleteChat = () => {
    ...
    db.ref("/tradeRequests/" + user.uid + "/" + this.props.chatKey)
      .update({
        deleted: true,
      })
      .then(() => {
      ...
      .catch((err) => {
        Alert.alert(
          "Error",
          "There was an error deleting this chat,please try again later."
        );
      });
  ...
  render() {
    console.log(".props.chatKey", this.props.chatKey && this.props.chatKey);
    var swipeoutBtns = [
      {
        // text: 'Delete',
    ...
    return (
      ...
      >
        <Swipeout
          right={swipeoutBtns}
          autoClose={true}
          disabled={this.props.status === "Deleted" ? true : false}
        >
          <TouchableOpacity
          ...
          >
            ...
            >
              ...
              />
              {this.props.unread ? (
                <View style={styles.unreadCircle}></View>
              ) : null}
            </View>
            <View
              style={{
            ...
            >
              ...
              >
                ...
                >
                  {this.props.company} ({this.props.status})
                </Text>
                <Text
                  style={{
                    fontWeight: "bold",
                ...
                >
                  {this.props.cost ? "N " + this.props.cost : ""}
                </Text>
              </View>
              <View
                style={{
