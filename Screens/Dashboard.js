...
// import { Item, Input, Icon } from "react-native-elements";
      ...
      <View style={{ flex: 1, width: "100%" }}>
        <View style={{ padding: RFValue(20) }}>
          ...
          >
            ...
            >
              {this.state.giftCards ? "GIFT CARDS" : "BITCOIN"}
            </Text>
            <TouchableOpacity
              onPress={() => {
                this.setState({ giftCards: !this.state.giftCards });
              }}
            >
              <Text
                style={{
          ...
          <View style={{ borderRadius: RFValue(7) }}>
            <Input
        ...
        >
          {this.state.giftCards ? (
            ...
            >
              {this.state.giftCardList.map((card, index) => {
                if (
                  this.state.searchKeyword.length < 1 ||
                  card.name
                    .toLowerCase()
                    .search(this.state.searchKeyword.toLowerCase()) !== -1
                )
                  return (
                    <Card
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  this.cardScroll.current.scrollTo({
                    x: this.xOffset - this.screenWidth + 50,
                    y: 0,
                    animated: true,
                  });
                }}
          ...
          <View
            style={{ marginTop: RFValue(25), paddingHorizontal: RFValue(20) }}
          >
            <Text style={{ fontSize: RFValue(15), fontWeight: "bold" }}>
              Hot Rate for {new Date().getDate()}{" "}
            ...
            {this.state.featuredCard ? (
              <TouchableOpacity
                style={[
                  styles.bestSeller,
                  { backgroundColor: this.state.featuredCard.color },
                ]}
                onPress={() => {
                  console.warn("Called");
                  this.props.navigation.navigate("CardDetails", {
                    ...
                    cost: this.state.featuredCard.minRate
                      ? this.state.featuredCard.minRate !=
                        this.state.featuredCard.maxRate
                        ? this.state.featuredCard.minRate +
                          "-" +
                          this.state.featuredCard.maxRate
                        : this.state.featuredCard.minRate
