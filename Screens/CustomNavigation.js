...
export default class CustomNavigation extends Component {
      ...
      options: [
        {
          ...
          color: "#F4511E",
          bg: "#FFCCBC",
          screenBg: "rgba(255, 204, 188, 0.1)",
          id: 0,
          bgAnim: new Animated.Value(255),
          fontAnim: new Animated.Value(1),
          screen: (
            <Dashboard
              switchToChat={() => {
                this.changeIndex(1);
        ...
        },
        {
          ...
          color: "#7CB342",
          bg: "#DCEDC8",
          screenBg: "rgba(220, 237, 200, 0.1)",
          id: 1,
          bgAnim: new Animated.Value(0),
          fontAnim: new Animated.Value(0),
          screen: <ChatMain />,
        },
        {
          name: "Profile",
  ...
  changeIndex = (index) => {
    ...
    for (let i = 0; i < this.state.options.length; i++) {
      if (i !== this.state.currentId) {
        ...
        this.state.options[this.state.currentId].fontAnim = new Animated.Value(
          0
        );
      }
  ...
  render() {
    const interpolateColor = this.state.options[
      this.state.currentId
    ].bgAnim.interpolate({
      inputRange: [0, 250],
      outputRange: [
        "rgb(255,255,255)",
        this.state.options[this.state.currentId].bg,
      ],
    });
      ...
      >
        <Animated.View
          style={[
            ...
            {
              opacity: this.state.screenFader,
              backgroundColor:
                this.state.options[this.state.currentId].screenBg,
            },
          ]}
        >
        ...
        <View style={styles.footerArea}>
          {this.state.options.map((option, index) => {
            return this.state.currentId === option.id ? (
              <Animated.View
                key={index}
                style={[
                  styles.selectedIcon,
