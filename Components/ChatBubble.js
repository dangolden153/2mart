...
export default class ChatBubble extends Component {
  ...
  componentDidMount() {
    ...
    const timeAdjusted =
      ...
      msgTime.getDate() +
      " " +
      this.getMonth(msgTime.getMonth());
  ...
  getContent = () => {
    if (this.props.image) {
      return (
        <View
          style={{
            flexDirection: this.props.recieved ? "row-reverse" : "row",
            width: "100%",
          }}
        >
          <View style={{ flex: 1 }}>
          ...
          <View
            style={
              this.props.recieved ? styles.bubbleRecieve : styles.bubbleSend
            }
          >
            <TouchableOpacity
      ...
      return (
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ color: this.props.recieved ? "white" : "black" }}>
                {" "}
                {this.props.content}{" "}
              </Text>
              <Text
        ...
        <Modal visible={this.state.openImageModal} transparent={true}>
          ...
          >
            ...
            >
              <MaterialIcons
                name="close"
                style={{ padding: RFValue(5), color: "black" }}
              />
            </TouchableOpacity>
          </View>
        </Modal>
