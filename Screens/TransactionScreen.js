...
export default class TransactionScreen extends Component {
      ...
      .on("value", (snap) => {
        ...
        snap.forEach((transaction) => {
          ...
          if (transaction.val().status !== "Pending") {
            transactions.push({
              name: transaction.val().cardName
                ? transaction.val().cardName
                : "Withdrawal",
  ...
  deleteTransaction = (key) => {
    ...
    //         console.warn(snap.val())
    //     })
    db.ref("/tradeRequests/" + user.uid + "/" + key)
      .update({
      ...
      .catch((err) => {
        Alert.alert(
          "Error",
          "There was an error deleting this transaction,please try again later."
        );
      });
  };
        ...
        <View style={styles.card}>
          <View style={{ flex: 1 }}>
            ...
            <Image
              ...
              style={{ height: 32, width: "100%", tintColor: "white" }}
              resizeMode="contain"
            />
            <View style={{ paddingTop: RFValue(30) }}>
              ...
              >
                ...
                <Text style={{ color: "white", fontSize: RFValue(9) }}>
                  Successful Transactions: {this.state.successful}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                <View>
                  <Text style={{ color: "white", fontSize: RFValue(9) }}>
                    Failed Transactions: {this.state.failed}
                  </Text>
                  <Text
                    style={{
                      color: "white",
                  ...
                  >
                    Reward Tokens: {this.state.userTokens}
                  </Text>
                </View>
              </View>
            </View>
        ...
        >
          <TouchableOpacity
            ...
            style={{
              ...
              backgroundColor:
                this.state.selected === 0 ? "#D1CCDC" : "transparent",
            }}
          >
            <Text>All</Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: RFValue(8),
              backgroundColor:
                this.state.selected === 1 ? "#D1CCDC" : "transparent",
            }}
          >
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: RFValue(8),
              backgroundColor:
                this.state.selected === 2 ? "#D1CCDC" : "transparent",
            }}
          >
            <Text>Failed</Text>
          </TouchableOpacity>
        ...
        >
          ...
          {this.state.transactions.map((transaction, index) => {
            if (
              ...
              (this.state.selected === 1 && transaction.success === true) ||
              (this.state.selected === 2 && transaction.success === false)
            ) {
              if (!transaction.deletedTransaction) {
                return (
                  <TransactionCard
                    ...
                    deleteTransaction={() => {
                      this.deleteTransaction(transaction.transactionKey);
                    }}
                  />
                );
              }
